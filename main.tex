...
\begin{blackbox}{\begin{center}\LARGE\textcolor{red}{Work\hspace{0.5cm}Log}\end{center}}
    ...
    \normalsize\indent \vline\textbf{------------}\hyperlink{page.33}{\fcolorbox{blue}{white}{Mon 07/17}}\textbf{------}\hyperlink{page.33}{\fcolorbox{blue}{white}{Tue 07/18}}\textbf{------}\hyperlink{page.33}{\fcolorbox{blue}{white}{Wed 07/19}}\textbf{------}\hyperlink{page.33}{\fcolorbox{blue}{white}{Thrs 07/20}}\textbf{------}\fcolorbox{blue}{white}{Fri 07/21} \\
...
\normalsize\begin{bluebox}{Monday, July 17th\vspace{-2.2em}\begin{flushright}Dev's Log \texttt{\#14}\hspace{0.5cm}\emoji{technologist}\emoji{open-book}\end{flushright}}
    \begin{itemize}         
        ...
        \textbf{TODO:} Research government and industry policy to add relevant tests to \codebox{test/} directory; finalize and build functionality; beautify site; write documentation; consider adding a frontend/backend if time remains; create presentation/final-writeup.
    \end{itemize}
\end{bluebox}
...
\normalsize\begin{bluebox}{Wednesday, July 19th\vspace{-2.2em}\begin{flushright}Campus Visit \emoji{metro}\emoji{office-building}\end{flushright}}
    \begin{itemize}         
        \item Visited the NIST Gaithersburg Campus. 
        \vspace{-0.5em}
        \item Continued writing \& passing tests for the \codebox{test} directory.
    \end{itemize}
\end{bluebox}
