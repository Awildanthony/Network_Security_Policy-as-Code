...
% for typesetting console commands
    ...
    % bob`\SU{bob}`
    % _
% for drawing realistic command shell window; commented out part is for 2nd user 'Bob'
...
\begin{itemize}
    ...
    \item\textbf{TODO:} Explore our \href{https://github.com/users/aj-stein-nist/projects/2}{\textbf{Github Project Board}}.
\end{itemize}
\end{redbox}
\newpage
