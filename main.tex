...
\begin{redbox}{Tuesday, May 23rd (cont. \#1/2)\vspace{-2.2em}\begin{flushright}\large\emoji{beer}\emoji{technologist}\end{flushright}}
\begin{MacTerminal}
...
\end{center}
\end{redbox}
\begin{redbox}{Tuesday, May 23rd (cont. \#2/2)\vspace{-2.2em}\begin{flushright}\large\emoji{beer}\emoji{technologist}\end{flushright}}
\begin{itemize}
...
\begin{redbox}{Wednesday, May 24th (cont. \#1/2)\vspace{-2.2em}\begin{flushright}\large\emoji{fire}\emoji{brick}\end{flushright}}
\begin{itemize}
    \begin{itemize}
...
\end{itemize}
\end{redbox}
\begin{redbox}{Wednesday, May 24th (cont. \#2/2)\vspace{-2.2em}\begin{flushright}\large\emoji{fire}\emoji{brick}\end{flushright}}
    \begin{MacTerminal}
...
\newpage
\begin{bloodorangebox}{Tuesday, May 30th (Cont. \#1/1)\vspace{-2.2em}\begin{flushright}\large\emoji{left-right-arrow}\emoji{warning}\end{flushright}}
\begin{ubuntu}
Chain INPUT (policy ACCEPT)
target     prot opt source               destination         
...
\begin{bloodorangebox}{Thursday, June 1st (Cont. \#1/1)\vspace{-2.2em}\begin{flushright}\large \emoji{bug}\emoji{shark}\end{flushright}}
\begin{itemize}
...
\begin{orangebox}{Wednesday, June 7th (Cont. \#1/1)\vspace{-2.2em}\begin{flushright}\large \emoji{hamster}\emoji{counterclockwise-arrows-button}\end{flushright}}
...
\end{itemize}
\end{orangebox}
\begin{orangebox}{Thursday, June 8th (Cont. \#1/2)\vspace{-2.2em}\begin{flushright}\emoji{detective}\emoji{exclamation-question-mark}\end{flushright}}
\begin{itemize}
...
\end{itemize}
    ...
    \end{center}
\end{orangebox}
\begin{orangebox}{Thursday, June 8th (Cont. \#2/2)\vspace{-2.2em}\begin{flushright}\emoji{detective}\emoji{exclamation-question-mark}\end{flushright}}
\begin{itemize}
...
\begin{hulkgreenbox}{Wednesday, July 5th\vspace{-2.2em}\begin{flushright}Dream web framework \emoji{zzz}\emoji{two-hump-camel}\end{flushright}}
    \begin{itemize}
...
\begin{hulkgreenbox}{Wednesday, July 5th (Cont. \#1/1)\vspace{-2.2em}\begin{flushright}\emoji{zzz}\emoji{two-hump-camel}\end{flushright}}
    \begin{itemize}
        \begin{itemize}
