...
\begin{blackbox}{\begin{center}\LARGE\textcolor{red}{Work\hspace{0.5cm}Log}\end{center}}
    ...
    \normalsize\indent \vline\textbf{------------}\hyperlink{page.31}{\fcolorbox{oceanblue}{white}{Mon 07/10}}\textbf{------}\hyperlink{page.32}{\fcolorbox{oceanblue}{white}{Tue 07/11}}\textbf{------}\hyperlink{page.32}{\fcolorbox{oceanblue}{white}{Wed 07/12}}\textbf{------}\hyperlink{page.32}{\fcolorbox{oceanblue}{white}{Thrs 07/13}}\textbf{------}\fcolorbox{oceanblue}{white}{Fri 07/14} \\
...
\normalsize\begin{oceanbluebox}{Monday, July 10th\vspace{-2.2em}\begin{flushright}XSS \& CSRF Attacks \emoji{cookie}\emoji{ogre}\end{flushright}}
    \begin{itemize}         
        ...
        \vspace{-0.25em}
        \item Discovered the \href{https://github.com/usnistgov/ngpac/commit/b6d58f86032b3221fb0d209190066e721e26e094}{\textbf{reason}} why my \codebox{.gitignore} wasn't ignoring \codebox{\_esy/} or related folders was because their compilation includes their own \codebox{.gitignore} file with a \codebox{!*} override command; this isn't an issue, but it presents the project as mostly JS.
        \vspace{-0.25em}
...
\normalsize\begin{oceanbluebox}{Wednesday, July 12th\vspace{-2.2em}\begin{flushright}Dev's Log \texttt{\#11}\hspace{0.5cm}\emoji{technologist}\emoji{open-book}\end{flushright}}
    \begin{itemize}         
        \item Spent the day writing \href{https://github.com/usnistgov/ngpac/commit/1ab9477a2d65b6155800c20ccd7a24aed0ffbde4}{\textbf{test files}} for all helper functions. \\
