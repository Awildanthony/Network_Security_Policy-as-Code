...
\vspace{0.25em}
\indent\vline\normalsize\textbf{------------}\hyperlink{page.3}{\fcolorbox{red}{white}{Mon 05/22}}\textbf{------}\hyperlink{page.3}{\fcolorbox{red}{white}{Tue 05/23}}\textbf{------}\hyperlink{page.5}{\fcolorbox{red}{white}{Wed 05/24}}\textbf{------}\hyperlink{page.7}{\fcolorbox{red}{white}{Thrs 05/25}}\textbf{------}\hyperlink{page.7}{\fcolorbox{red}{white}{Fri 05/26}} \\
...
\normalsize\indent \vline\textbf{------------}\hyperlink{page.14}{\fcolorbox{orange}{white}{Mon 06/05}}\textbf{------}\hyperlink{page.15}{\fcolorbox{orange}{white}{Tue 06/06}}\textbf{------}\hyperlink{page.16}{\fcolorbox{orange}{white}{Wed 06/07}}\textbf{------}\hyperlink{page.18}{\fcolorbox{orange}{white}{Thrs 06/08}}\textbf{------}\hyperlink{page.21}{\fcolorbox{orange}{white}{Fri 06/09}} \\

\vspace{-1em}
\hspace{-0.3cm}\small\hyperlink{page.22}{\textbf{WEEK [VI.]}}
\vspace{0.25em}

\normalsize\indent \vline\textbf{------------}\hyperlink{page.22}{\fcolorbox{shininggold}{white}{Mon 06/12}}\textbf{------}\fcolorbox{shininggold}{white}{Tue 06/13}\textbf{------}\fcolorbox{shininggold}{white}{Wed 06/14}\textbf{------}\fcolorbox{shininggold}{white}{Thrs 06/15}\textbf{------}\fcolorbox{shininggold}{white}{Fri 06/16} \\
...
\normalsize\begin{redbox}{Monday, May 22nd\vspace{-2em}\begin{flushright}\large\textbf{Virtual Orientation} \emoji{laptop}\emoji{wave}\end{flushright}}
\begin{itemize}
...
\begin{redbox}{Tuesday, May 23rd\vspace{-2em}\begin{flushright}\large\textbf{VM Struggles} \emoji{beer}\emoji{technologist}\end{flushright}}
\begin{itemize}
...
\begin{redbox}{Tuesday, May 23rd (cont. \#1/2)\vspace{-2em}\begin{flushright}\large\emoji{beer}\emoji{technologist}\end{flushright}}
\begin{MacTerminal}
...
\end{center}
\end{redbox}
\begin{redbox}{Tuesday, May 23rd (cont. \#2/2)\vspace{-2em}\begin{flushright}\large\emoji{beer}\emoji{technologist}\end{flushright}}
\begin{itemize}
...
\begin{redbox}{Wednesday, May 24th\vspace{-2em}\begin{flushright}\large\textbf{Firewall Struggles} \emoji{fire}\emoji{brick}\end{flushright}}
\begin{itemize}
...
\begin{redbox}{Wednesday, May 24th (cont. \#1/2)\vspace{-2em}\begin{flushright}\large\emoji{fire}\emoji{brick}\end{flushright}}
\begin{itemize}
    \begin{itemize}
...
\end{itemize}
\end{redbox}
\begin{redbox}{Wednesday, May 24th (cont. \#2/2)\vspace{-2em}\begin{flushright}\large\emoji{fire}\emoji{brick}\end{flushright}}
    \begin{MacTerminal}
...
\begin{redbox}{Thursday, May 25th\vspace{-2em}\begin{flushright}\large\textbf{Documentation Begins} \emoji{memo}\emoji{art}\end{flushright}}
\begin{itemize}
...
\begin{redbox}{Friday, May 26th\vspace{-2em}\begin{flushright}\large\textbf{Catch-Up} \emoji{runner}\emoji{check-mark-button}\end{flushright}}
\begin{itemize}
...
\normalsize\begin{bloodorangebox}{Tuesday, May 30th\vspace{-2em}\begin{flushright}\large\textbf{Success with \texttt{iptables}} \emoji{left-right-arrow}\emoji{warning}\end{flushright}}
\begin{itemize}
...
\newpage
\begin{bloodorangebox}{Tuesday, May 30th (Cont. \#1/1)\vspace{-2em}\begin{flushright}\large\emoji{left-right-arrow}\emoji{warning}\end{flushright}}
\begin{ubuntu}
Chain INPUT (policy ACCEPT)
target     prot opt source               destination         
...
\begin{bloodorangebox}{Wednesday, May 31st\vspace{-2em}\begin{flushright}\large\textbf{Investigating Protocols} \emoji{open-book}\emoji{p-button}\end{flushright}}
\begin{center}
\vspace{-0.5em}
...
\begin{bloodorangebox}{Thursday, June 1st\vspace{-2em}\begin{flushright}\large\textbf{GitHub Bug Issue \& Wireshark} \emoji{bug}\emoji{shark}\end{flushright}}
\begin{itemize}
...
\begin{bloodorangebox}{Thursday, June 1st (Cont. \#1/1)\vspace{-2em}\begin{flushright}\large \emoji{bug}\emoji{shark}\end{flushright}}
\begin{itemize}
...
\begin{bloodorangebox}{Friday, June 2nd\vspace{-2em}\begin{flushright}\large\textbf{Wireshark: File Excavation} \emoji{pick}\emoji{shark}\end{flushright}}
\begin{itemize}
...
\normalsize\begin{orangebox}{Monday, June 5th\vspace{-2em}\begin{flushright}\large\textbf{Firewalls \& Network Traffic} \emoji{globe-with-meridians}\emoji{vertical-traffic-light}\end{flushright}}
\begin{itemize}
...
\begin{orangebox}{Tuesday, June 6th\vspace{-2em}\begin{flushright}\large\textbf{UTM (new VM) \& Suricata} \emoji{penguin}\emoji{hamster}\end{flushright}}
\begin{itemize}
...
\begin{orangebox}{Wednesday, June 7th\vspace{-2em}\begin{flushright}\large\textbf{UTM \& Suricata, Continued} \emoji{hamster}\emoji{counterclockwise-arrows-button}\end{flushright}}
\begin{itemize}
...
\begin{orangebox}{Wednesday, June 7th (Cont. \#1/1)\vspace{-2em}\begin{flushright}\large \emoji{hamster}\emoji{counterclockwise-arrows-button}\end{flushright}}
...
\normalsize\begin{orangebox}{Thursday, June 8th\vspace{-2em}\begin{flushright}\large Q\&A with VPNs \emoji{detective}\emoji{exclamation-question-mark}\end{flushright}}
\begin{itemize}
...
\end{itemize}
\end{orangebox}
\begin{orangebox}{Thursday, June 8th (Cont. \#1/2)\vspace{-2em}\begin{flushright}\emoji{detective}\emoji{exclamation-question-mark}\end{flushright}}
\begin{itemize}
...
\end{itemize}
    ...
    \end{center}
\end{orangebox}
\begin{orangebox}{Thursday, June 8th (Cont. \#2/2)\vspace{-2em}\begin{flushright}\emoji{detective}\emoji{exclamation-question-mark}\end{flushright}}
\begin{itemize}
...
\normalsize\begin{orangebox}{Friday, June 9th\vspace{-2em}\begin{flushright}VPN Lab with AWS \emoji{microscope}\emoji{cloud}\end{flushright}}
\begin{itemize}
...
\begin{shininggoldbox}{Monday, June 12th\vspace{-2em}\begin{flushright}\large pcap expressions \emoji{candy}\emoji{pencil}\end{flushright}}
\begin{multicols}{2}
...
\begin{hulkgreenbox}{Wednesday, July 5th\vspace{-2em}\begin{flushright}Dream web framework \emoji{zzz}\emoji{two-hump-camel}\end{flushright}}
    \begin{itemize}
...
\begin{hulkgreenbox}{Wednesday, July 5th (Cont. \#1/1)\vspace{-2em}\begin{flushright}\emoji{zzz}\emoji{two-hump-camel}\end{flushright}}
    \begin{itemize}
        \begin{itemize}
            \item\href{https://github.com/aantron/dream/tree/master/example/6-echo}{\fbox{\textbf{\texttt{6-echo}}}} We pivot to echoing post requests from a separate terminal: this is still uninteresting, but the pace will pick up soon.
