...
\begin{blackbox}{\begin{center}\LARGE\textcolor{red}{Work\hspace{0.5cm}Log}\end{center}}
    ...
    \normalsize\indent \vline\textbf{------------}\hyperlink{page.28}{\fcolorbox{hulkgreen}{white}{Mon 07/03}}\textbf{------}\fbox{\hspace{0.22cm}Holiday\hspace{0.22cm}}\textbf{------}\fcolorbox{hulkgreen}{white}{Wed 07/05}\textbf{------}\fcolorbox{hulkgreen}{white}{Thrs 07/06}\textbf{------}\fcolorbox{hulkgreen}{white}{Fri 07/07} \\
...
\noindent\begin{longfbox}[
    ...
    \medskip
    \phantom{~~}\Large\textbf{WEEK \barroman{VI}.} \large(06/26 - 06/30)\phantom{~~~~~~~~~~~~~~~~~~~~~~~~~~~}\textbf{\textit{Continuing Development...}}
\end{longfbox}
\\
...
\begin{hulkgreenbox}{Wednesday, July 5th \hspace{0.2cm}\texttt{(cont. \#1/1)}\vspace{-2.2em}\begin{flushright}\emoji{zzz}\emoji{two-hump-camel}\end{flushright}}
    \begin{itemize}
        \begin{itemize}
