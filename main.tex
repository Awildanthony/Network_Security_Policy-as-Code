...
\normalsize\indent \vline\textbf{------------}\hyperlink{page.14}{\fcolorbox{orange}{white}{Mon 06/05}}\textbf{------}\fcolorbox{orange}{white}{Tue 06/06}\textbf{------}\fcolorbox{orange}{white}{Wed 06/07}\textbf{------}\fcolorbox{orange}{white}{Thrs 06/08}\textbf{------}\fcolorbox{orange}{white}{Fri 06/09} \\
...
\begin{itemize}
    \item Did some research into the hierarchy of firewalls:
\end{itemize}
\vspace{-2.5em}
\begin{center}
\begin{tikzpicture}
    \hspace{-0.05cm}\filldraw[color=blue, fill=blueone!90, very thick](0,0) rectangle (15.5,13);
    \node[text width=15.5cm] at (8, 12.25) {\textcolor{white}{\underline{\large\textbf{Next-Generation Firewall (NGFW)}:}\\
    \scriptsize $\bullet$ Deep Packet Inspection (DPI), Intrusion Detection/Prevention, Malware Filtering, AntiVirus, phishing, etc.}};
        \begin{scope}[xshift = 0.25cm, yshift = 0.25cm]
            \filldraw[color=blue, fill=bluetwo!90, very thick](0,0) rectangle (8.65,11.25);
            \node[text width=8.25cm] at (4.3, 9.3) {\textcolor{white}{\underline{\large\textbf{Stateful Inspection Firewall}:}\\
            \vspace{0.25em}
        ...
        \begin{scope}[xshift = 9.2cm, yshift = 0.25cm]
            \filldraw[color=blue, fill=bluetwo!90, very thick](0,0) rectangle (6.1,11.25);
        \end{scope}
\end{tikzpicture}
\end{center}
\end{orangebox}
