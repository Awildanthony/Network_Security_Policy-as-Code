...
\begin{blackbox}{\begin{center}\LARGE\textcolor{red}{Work\hspace{0.5cm}Log}\end{center}}
    ...
    \normalsize\indent \vline\textbf{------------}\hyperlink{page.34}{\fcolorbox{darkblue}{white}{Mon 07/24}}\textbf{------}\hyperlink{page.34}{\fcolorbox{darkblue}{white}{Tue 07/25}}\textbf{------}\hyperlink{page.34}{\fcolorbox{darkblue}{white}{Wed 07/26}}\textbf{------}\hyperlink{page.34}{\fcolorbox{darkblue}{white}{Thrs 07/27}}\textbf{------}\hyperlink{page.34}{\fcolorbox{darkblue}{white}{Fri 07/28}} \\
    
    \vspace{-1em}
    \hspace{-0.3cm}\small\hyperlink{page.35}{\textbf{WEEK [XI.]}}
    \vspace{0.25em}
    
    \normalsize\indent \vline\textbf{------------}\hyperlink{page.35}{\fcolorbox{indigo}{white}{Mon 07/31}}\textbf{------}\hyperlink{page.35}{\fcolorbox{indigo}{white}{Tue 08/01}}\textbf{------}\hyperlink{page.35}{\fcolorbox{indigo}{white}{Wed 08/02}}\textbf{------}\hyperlink{page.35}{\fcolorbox{indigo}{white}{Thrs 08/03}}
\end{blackbox}
...
\normalsize\begin{darkbluebox}{Tuesday, July 25th\vspace{-2.2em}\begin{flushright}Drafting Presentation \emoji{speaking-head}\emoji{megaphone}\end{flushright}}
    \begin{itemize}         
...
\normalsize\begin{darkbluebox}{Wednesday, July 26th\vspace{-2.2em}\begin{flushright}Drafting Presentation \emoji{speaking-head}\emoji{megaphone}\end{flushright}}
    \begin{itemize}         
        \item Finished presentation (slides 9-16).    
    \end{itemize}
\end{darkbluebox}
...
\normalsize\begin{indigobox}{Wednesday, August 2nd\vspace{-2.2em}\begin{flushright}Dev's Log \texttt{\#20}\hspace{0.5cm}\emoji{technologist}\emoji{open-book}\end{flushright}}
    \begin{itemize}         
        \item Borrowed \href{https://github.com/usnistgov/ngpac/blob/main/LICENSE.md}{\codebox{LICENSE.md}} and \href{https://github.com/usnistgov/ngpac/blob/main/CONTRIBUTING.md}{\codebox{CONTRIBUTING.md}} from \href{https://github.com/usnistgov/OSCAL}{\textbf{OSCAL}} team.     
    \end{itemize}
\end{indigobox}
...
\normalsize\begin{indigobox}{Thursday, August 3rd\vspace{-2.2em}\begin{flushright}Gave Presentation \emoji{speaking-head}\emoji{megaphone}\end{flushright}}
    \begin{itemize}
